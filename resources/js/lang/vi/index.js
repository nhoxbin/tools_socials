...
export default {
	...
	autoComment: 'Tự động bình luận',
	infoReactions: 'Thông tin cảm xúc',
	friendsList: 'Danh sách bạn bè',
	myFriends: 'Bạn của tui',
	notMyFriends: 'Ko phải bạn của tui',
	groupsList: 'Danh sách nhóm',
	infoListFriends: 'Thông tin danh sách bạn bè',
	infoToGetListFriends: 'Thông tin để lấy danh sách bạn',
	getListFriendsWithID: 'Lấy danh sách bạn bằng ID',
	listFriendsOfID: 'Danh sách bạn của ID trên',

	infoToLoginFB: 'Thông tin đăng nhập Facebook',
	yourInfoAccountFB: 'Thông tin tài khoản Facebook của bạn',
	rankInbox: 'Xếp hạng cuộc trò chuyện',
